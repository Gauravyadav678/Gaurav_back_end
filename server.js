...
app.post('/api/categories', async (req, res) => {
    const { Category_display_name, title, price, description, imageUrl,inStock } = req.body;
   console.log("data from seller",req.body);

  if (!Category_display_name || !title || !price || !description || !imageUrl || !inStock) {
